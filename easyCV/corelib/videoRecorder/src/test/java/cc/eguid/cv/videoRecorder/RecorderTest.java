...
public class RecorderTest {
	...
	public static void testSingle(TasksManager manager) throws Exception {
		...
		System.out.println("最后一个，历史任务数量："+manager.historylist().size());
		manager.stop(task);
	}
	//多个同时测试
...
//		System.err.println("历史任务数量："+manager.historylist().size());
//		
//		Thread.sleep(5*1000);
//		//暂停全部
...
//			record.forward();
			...
			record.from("rtmp://media3.sinovision.net:1935/live/livestream").to("eguid.mp4").start();
